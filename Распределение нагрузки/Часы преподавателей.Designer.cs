namespace Распределение_нагрузки
{
    partial class Часы_преподавателей
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.преподавателиНеВсеЧасыХПBindingSource1 = new System.Windows.Forms.BindingSource(this.components);
            ...
            this.Недобор = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.Перебор = new System.Windows.Forms.DataGridViewTextBoxColumn();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.преподавателиНеВсеЧасыХПBindingSource1)).BeginInit();
            this.SuspendLayout();
            // 
            // dataGridView1
            // 
            ...
            this.Недобор,
            this.Перебор});
            this.dataGridView1.DataSource = this.преподавателиНеВсеЧасыХПBindingSource1;
            ...
            // 
            // преподавателиНеВсеЧасыХПBindingSource1
            // 
            this.преподавателиНеВсеЧасыХПBindingSource1.DataMember = "ПреподавателиНеВсеЧасы_ХП";
            this.преподавателиНеВсеЧасыХПBindingSource1.DataSource = this.распределениеНагрузкиDataSet1;
            // 
            ...
            // Недобор
            // 
            this.Недобор.DataPropertyName = "Недобор";
            this.Недобор.HeaderText = "Недобор";
            this.Недобор.Name = "Недобор";
            this.Недобор.ReadOnly = true;
            // 
            // Перебор
            // 
            this.Перебор.DataPropertyName = "Перебор";
            this.Перебор.HeaderText = "Перебор";
            this.Перебор.Name = "Перебор";
            this.Перебор.ReadOnly = true;
            // 
            // Часы_преподавателей
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.преподавателиНеВсеЧасыХПBindingSource1)).EndInit();
        ...
        private System.Windows.Forms.BindingSource преподавателиНеВсеЧасыХПBindingSource1;
        ...
        private System.Windows.Forms.DataGridViewTextBoxColumn Недобор;
        private System.Windows.Forms.DataGridViewTextBoxColumn Перебор;
    }
}