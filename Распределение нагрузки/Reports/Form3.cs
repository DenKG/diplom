...
namespace Распределение_нагрузки
{
    public partial class общийОтчетForm : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "РаспределениеНагрузкиDataSet.ОтчетПоАкадемсоветникам_ХП". При необходимости она может быть перемещена или удалена.
            this.ОтчетПоАкадемсоветникам_ХПTableAdapter.Fill(this.РаспределениеНагрузкиDataSet.ОтчетПоАкадемсоветникам_ХП);
